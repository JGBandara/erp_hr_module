...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::put('departments/{id}', [DepartmentController::class, 'update'])->middleware('check.permission:edit-department');
    Route::delete('departments/{id}', [DepartmentController::class, 'destroy'])->middleware('check.permission:delete-department');
});
